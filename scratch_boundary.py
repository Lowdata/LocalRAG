def test_bug():
    ...
    if new_start > 0 and text[new_start - 1] not in (" ", "\n"):
        print(
            f"Before snapping: new_start={new_start}, text starts with '{text[new_start:new_start+10]}'"
        )
        ...
        print(
            f"After snapping: new_start={new_start}, text starts with '{text[new_start:new_start+10]}'"
        )
